...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-04-2021 a las 18:57:31
...
--
ALTER TABLE `uvas`
  ADD CONSTRAINT `uvas_ibfk_1` FOREIGN KEY (`id_vino`) REFERENCES `new_vinos` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
COMMIT;
