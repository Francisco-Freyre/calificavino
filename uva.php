                                        ...
                                        <h4 class="card-title">Uvas que contiene el vino</h4>      
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <input list="uvas" type="text" id="uva" data-id="<?=$_GET['id']?>" class="form-control"
                                                                placeholder="Uva">
                                                            <datalist id="uvas">
                                            ...
                                            <div class="form-actions">
                                                <div class="text-right">
                                                    <button id="guardar-uva" data-id="<?=$_GET['id']?>" type="submit" class="btn btn-info">Guardar</button>
                                                </div>
                                            </div>
