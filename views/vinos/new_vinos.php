<!-- ============================================================== -->
            ...
            <div class="container-fluid">
                <form action="<?=base_url?>vino/save" method="POST" enctype="multipart/form-data">
                    <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <table id="zero_config" class="table table-striped no-wrap">
                                            ...
                                            <?php while($cat = $cata->fetch_object()): ?>   
                                                <tr class="text-center">
                                                    <td><img  src="<?=base_url.$cat->url_img?>" alt="imagen" class="rounded-circle" width="50" height="50"></td>
                                                    <td><a href="<?=base_url?>vino/edit&id=<?=$cat->id?>" style="color: #ba2e53;"><?=$cat->nombre?></a></td>
                                                    <td><?=$cat->uva?></td>
                                                    <td><?=$cat->pais?></td>
                                                    <td><?=$cat->region?></td>
                                                    <td><?=$cat->productor?></td>
                                                    <td>
                                                    <a href="<?=base_url?>vino/delete&id=<?=$cat->id?>" class="btn waves-effect waves-light btn-danger" data-toggle="tooltip" data-placement="top" title data-original-title="Eliminar">
