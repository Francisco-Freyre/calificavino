            ...
            <!-- ============================================================== -->
                    <div class="container-fluid">
                        ...
                        <!-- Start Page Content -->
                        <!-- ============================================================== -->
                        <form action="<?=base_url?>cata/saveCalif" method="POST">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="range" name="capa" class="form-control" min="0"
                                                                    max="3">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="mb-3">
                                                                <div class="row g-2">
                                                                    ...
                                                                    <div class="col-auto">
                                                                        <label class="form-colorinput">
                                                                            <input id="colorEspuma"
                                                                                class="form-colorinput-input"
                                                                                type="radio" name="color-rounded"
                                                                                value="blue">
                                                                            <span
                                                                                class="form-colorinput-color bg-espu rounded-circle"></span>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" id="customRadio1" name="customRadio"
                                                                            class="custom-control-input" value="Violaceo">
                                                                        <label class="custom-control-label"
                                                                            for="customRadio1">Violaceo</label>
                                                                        <img src="<?=base_url?>assets/images/violaceo.png"
                                                                            alt="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" id="customRadio2" name="customRadio"
                                                                            class="custom-control-input" value="Rubi" >
                                                                        <label class="custom-control-label"
                                                                            for="customRadio2">Rubi</label>
                                                                            <br>
                                                                        <img src="<?=base_url?>assets/images/rubi.png"
                                                                            alt="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" id="customRadio3" name="customRadio"
                                                                            class="custom-control-input" value="Granate">
                                                                        <label class="custom-control-label"
                                                                            for="customRadio3">Granate</label>
                                                                        <img src="<?=base_url?>assets/images/granate.png"
                                                                            alt="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" id="customRadio4" name="customRadio"
                                                                            class="custom-control-input" value="Tinto naranja">
                                                                        <label class="custom-control-label"
                                                                            for="customRadio4">Tinto Naranja</label>
                                                                        <img src="<?=base_url?>assets/images/tintonaranja.png"
                                                                            alt="">
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" id="customRadio5" name="customRadio"
                                                                            class="custom-control-input" value="Grosella">
                                                                        <label class="custom-control-label"
                                                                            for="customRadio5">Grosella</label>
                                                                        <img src="<?=base_url?>assets/images/grosella.png"
                                                                            alt="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" id="customRadio6" name="customRadio"
                                                                            class="custom-control-input" value="Frambuesa">
                                                                        <label class="custom-control-label"
                                                                            for="customRadio6">Frambuesa</label>
                                                                        <img src="<?=base_url?>assets/images/frambueza.png"
                                                                            alt="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" id="customRadio7" name="customRadio"
                                                                            class="custom-control-input" value="Rosa claro">
                                                                        <label class="custom-control-label"
                                                                            for="customRadio7">Rosa claro</label>
                                                                        <img src="<?=base_url?>assets/images/rosaclaro.png"
                                                                            alt="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" id="customRadio8" name="customRadio"
                                                                            class="custom-control-input" value="Rosa Palido">
                                                                        <label class="custom-control-label"
                                                                            for="customRadio8">Rosa Palido</label>
                                                                        <img src="<?=base_url?>assets/images/rosapalido.png"
                                                                            alt="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" id="customRadio9" name="customRadio"
                                                                            class="custom-control-input" value="Salmon">
                                                                        <label class="custom-control-label"
                                                                            for="customRadio9">Salmon</label>
                                                                        <img src="<?=base_url?>assets/images/salmon.png"
                                                                            alt="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" id="customRadio10"
                                                                            ...
                                                                            value="Naranja">
                                                                        <label class="custom-control-label"
                                                                            for="customRadio10">Naranja</label>
                                                                        <img src="<?=base_url?>assets/images/naranja.png"
                                                                            alt="">
                                                                    </div>
                                                                </div>  
                                                            </div>
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" id="customRadio11"
                                                                            name="customRadio"
                                                                            class="custom-control-input" value="Amarillo verdozo">
                                                                        <label class="custom-control-label"
                                                                            for="customRadio11">Amarillo verdozo</label>
                                                                        <img src="<?=base_url?>assets/images/marilloverdozo.png"
                                                                            alt="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" id="customRadio12"
                                                                            name="customRadio"
                                                                            class="custom-control-input" value="Amarillo palido">
                                                                        <label class="custom-control-label"
                                                                            for="customRadio12">Amarillo palido</label>
                                                                        <img src="<?=base_url?>assets/images/amarillopalido.png"
                                                                            alt="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" id="customRadio13"
                                                                            name="customRadio"
                                                                            class="custom-control-input" value="Amarillointenso">
                                                                        <label class="custom-control-label"
                                                                            for="customRadio13">Amarillo intenso</label>
                                                                        <img src="<?=base_url?>assets/images/Amarillointenso.png"
                                                                            alt="">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" id="customRadio14"
                                                                            name="customRadio"
                                                                            class="custom-control-input" value="Dorado">
                                                                        <label class="custom-control-label"
                                                                            for="customRadio14">Dorado</label>
                                                                            <br>
                                                                            <br>
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" id="customRadio15"
                                                                            name="customRadio"
                                                                            class="custom-control-input" value="Amabar">
                                                                        <label class="custom-control-label"
                                                                            for="customRadio15">Amabar</label>
                                                                            <br>
                                                                            <br>
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="custom-control custom-radio">
                                                                        <input type="radio" id="customRadio16"
                                                                            name="customRadio"
                                                                            class="custom-control-input" value="Cobre">
                                                                        <label class="custom-control-label"
                                                                            for="customRadio16">Cobre</label>
                                                                            <br>
                                                                            <br>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="customRadio17"
                                                                    name="customRadio" class="custom-control-input"
                                                                    value="Rosario lineal">
                                                                <label class="custom-control-label"
                                                                    for="customRadio17">Rosario lineal</label>
                                                            </div>
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="customRadio18"
                                                                    name="customRadio" class="custom-control-input"
                                                                    value="Rosario ondulado">
                                                                <label class="custom-control-label"
                                                                    for="customRadio18">Rosario ondulado</label>
                                                            </div>
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="customRadio19"
                                                                    ...
                                                                    value="Perlado fino">
                                                                <label class="custom-control-label"
                                                                    for="customRadio19">Perlado fino</label>
                                                            </div>
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="customRadio20"
                                                                    ...
                                                                    value="Perlado medio">
                                                                <label class="custom-control-label"
                                                                    for="customRadio20">Perlado medio</label>
                                                            </div>
                                                            <div class="custom-control custom-radio">
                                                                <input type="radio" id="customRadio21"
                                                                    name="customRadio" class="custom-control-input"
                                                                    value="Perlado grande">
                                                                <label class="custom-control-label"
                                                                    for="customRadio21">Perlado grande</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <h6 class="card-subtitle"></h6>
                                                            <div class="form-group">
                                                                <input type="range" class="form-control" min="0"
                                                                    max="2" name="brillo">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="range" class="form-control" min="0" max="1"
                                                                    step="0.1" id="calif1" name="calificacion1">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="range" class="form-control" min="0" max="2"
                                                                    step="0.1" id="calif2" name="calificacion2">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <input type="range" class="custom-range" id="customRange1" min="0"
                                                        max="4" name="dulce">
                                                    ...
                                                    <input type="range" class="custom-range" min="0" max="3"
                                                        id="customRange2" name="acidez">
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <input type="range" class="custom-range" min="0" max="3"
                                                        id="customRange3" name="permanencia">
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="card">
                                                        <div class="card-body">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <h6 class="card-subtitle">Valores del 0 al 3 (se
                                                                incluyen valores decimales)</h6>
                                                            <div class="form-group">
                                                                <input type="range" class="form-control" min="0" max="3"
                                                                    step="0.1" id="calif3" name="calificacion3">
                                                            ...
                                                            <h4 class="card-title">Comentarios</h4>
                                                                ...
                                                                <div class="form-group">
                                                                    <textarea class="form-control" rows="3"
                                                                        placeholder="Comentario" name="comentarios"></textarea>
                                                                </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <h4 class="card-title">Maridaje</h4>
                                                                ...
                                                                <div class="form-group">
                                                                    <textarea class="form-control" rows="3"
                                                                        placeholder="Comentario" name="meridaje"></textarea>
                                                                </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <h6 class="card-subtitle">Valores del 0 al 4 (se
                                                                incluyen valores decimales)</h6>
                                                            <div class="form-group">
                                                                <input type="range" class="form-control" min="0" max="4"
                                                                    step="0.1" id="calif4" name="calificacion4">
