<?php
    ...
    if(isset($_GET['id'])){
        $vino = new vinos();
        $visual = $vino->getVisual($_GET['id']);
        $aromas = $vino->getAroma($_GET['id']);
        $gustos = $vino->getGusto($_GET['id']);
        $palAromas = $vino->getPalabrasAromas($_GET['id']);
        $palGustos = $vino->getPalabrasGustos($_GET['id']);
        $apresiacion = $vino->getPersonal($_GET['id']);
...
<div class="container-fluid">
    ...
    <!-- Start Page Content -->
    <!-- ============================================================== -->
    <form action="controllers/obtener_vino.php?id_cata=<?=$_GET['id']?>" method="POST">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <input type="search" value="<?=$OAromas->aromas?>" class="form-control" id="aromas" data-id="<?=$_GET['id']?>">
                                        </div>

                                        <div class="row">
                                            <div class="col-md-12" id="chipss">
                                                <?php while($palAr = $palAromas->fetch_object()): ?>
                                                    <div class="chip" id="aroma<?=$palAr->id?>">
                                                        <?=$palAr->palabra?>
                                                        <span id="closebtn" class="closebtn" data-id="<?=$palAr->id?>">&times;</span>
                                                    </div>
                                                <?php endwhile;?>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <input type="search" value="<?=$OGustos->retrogusto?>" class="form-control" id="sabores" data-id="<?=$_GET['id']?>">
                                        </div>
                                        
                                        <div class="row">
                                            <div class="col-md-12" id="chipss2">
                                                <?php while($palGus = $palGustos->fetch_object()): ?>
                                                    <div class="chip" id="gusto<?=$palGus->id?>">
                                                        <?=$palGus->palabra?>
                                                        <span id="closebtn2" class="closebtn" data-id="<?=$palGus->id?>">&times;</span>
                                                    </div>
                                                <?php endwhile;?>
                                            </div>
                                        </div>
        ...
        <div class="row">
            <div class="col-lg-12 ">
                <input type="text" name="accion" value="update-calif" style="display: none;">
