            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        ...
                        <li class="breadcrumb-item text-muted" aria-current="page">Calificación</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="container-fluid">
    ...
    <form action="controllers/obtener_vino.php" method="POST" id="visual" <?php if($paso->paso == 0): ?> style="display: block;" <?php else: ?> style="display: none;" <?php endif;?>>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <input type="range" name="capa" class="form-control" min="0" max="3">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h6 class="card-subtitle"></h6>
                                        <div class="form-group">
                                            <input type="range" class="form-control" min="0" max="2" name="brillo">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h6 class="card-subtitle"></h6>
                                        <div class="form-group">
                                            <input type="range" class="form-control" min="0" max="2" name="viscocidad">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-lg-12 ">
                <input type="text" name="accion" value="insertar-visual" style="display: none;">
    ...
    <form action="controllers/obtener_vino.php" method="POST" id="aromatico" <?php if($paso->paso == 1): ?> style="display: block;" <?php else: ?> style="display: none;" <?php endif;?>>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h6 class="card-subtitle"></h6>
                                        <div class="form-group">
                                            <input type="range" class="form-control" min="0" max="3" name="intensisdad">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h6 class="card-subtitle"></h6>
                                        <div class="form-group">
                                            <input type="range" class="form-control" min="0" max="3" name="complejidad">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <input type="search" class="form-control" id="aromas" data-id="<?=$_GET['id_cata']?>">
                                        </div>
        ...
        <div class="row">
            <div class="col-lg-12 ">
                <input type="text" name="accion" value="insertar-aroma" style="display: none;">
                <button type="submit" class="btn btn-block btn-primary">Siguiente</button>
            </div>
        </div>
    </form>
    <form action="controllers/obtener_vino.php" method="POST" id="gustativo" <?php if($paso->paso == 2): ?> style="display: block;" <?php else: ?> style="display: none;" <?php endif;?>>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <input type="range" class="custom-range" id="customRange1" min="0" max="4" name="dulce">
                                ...
                                <input type="range" class="custom-range" min="0" max="3" id="customRange2" name="acidez">
                                ...
                                <input type="range" class="custom-range" min="0" max="4" id="customRange3" name="tanino">
                            </div>
                            <div class="col-lg-12">
                                ...
                                <input type="range" class="custom-range" id="customRange1" min="0" max="2" name="alcohol">
                                ...
                                <input type="range" class="custom-range" min="0" max="3" id="customRange2" name="cuerpo">
                                ...
                                <input type="range" class="custom-range" min="0" max="3" id="customRange3" name="permanencia">
                            </div>
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <input type="search" class="form-control" id="sabores" data-id="<?=$_GET['id_cata']?>">
                                        </div>

                                        <div class="row">
                                            <div class="col-md-12" id="chipss2">
                                                <!--<div class="chip">
                                                    Ejemplo
                                                    <span class="closebtn">&times;</span>
                                                </div>-->
        ...
        <div class="row">
            <div class="col-lg-12 ">
                <input type="text" name="accion" value="insertar-gusto" style="display: none;">
                <button type="submit" class="btn btn-block btn-primary">Siguiente</button>
            </div>
        </div>
    </form>
    <form action="controllers/obtener_vino.php?id_cata=<?=$_GET['id_cata']?>" method="POST" id="personal" <?php if($paso->paso == 3): ?> style="display: block;" <?php else: ?> style="display: none;" <?php endif;?>>
        ...
        <div class="row">
            <div class="col-lg-12 ">
                <input type="text" name="accion" value="insertar-presonal" style="display: none;">
                <button type="submit" class="btn btn-block btn-primary">Terminar</button>
            </div>
        </div>
    </form>
