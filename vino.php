...
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Nueva Cata</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.php" class="text-muted">Vinos</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Registro</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <form id="guardar-vino-imagen" action="controllers/obtener_vino.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
                                        ...
                                        <h4 class="card-title">Información de la etiqueta</h4>  
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            <input type="text" list="nombres" id="nombre2" name="nombre" class="form-control"
                                                        ...
                                                        <div class="form-group">
                                                            <input list="paises" type="text" name="pais" id="pais2" class="form-control"
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            <input list="regiones" type="text" name="region" id="region2" class="form-control"
                                            ...
                                            <div class="form-actions">
                                                <div class="text-right">
                                                    <input type="text" value="vino-nuevo" name="accion" style="display: none;">
                ...
                <div class="row">
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <div class="form-group">
                                                    <input list="paises" type="text" name="pais" id="pais" class="form-control"
                                                        placeholder="Pais">
                                                    <datalist id="paises">
                                                        <option value="ARGENTINA"></option>
                                                        <option value="AUSTRALIA"></option>
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <input list="regiones" type="text" name="region" id="region" class="form-control"
                                                        placeholder="Region">
                                                    <datalist id="regiones">
                                                        <option value="VALLE DE UCO"></option>
                                                        <option value="LUJAN DE CUYO"></option>
                                                ...
                                                <div class="form-group">
                                                    <input list="uvas" type="text" name="uva" id="uva" class="form-control"
                                                        placeholder="Uva">
                                                    <datalist id="uvas">
                    ...
                    <form action="controllers/obtener_vino.php" id="existe-vino" method="POST">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Añade los siguientes campos del vino que acabas de seleccionar</h4>  
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                        ...
                                        <div class="form-actions">
                                            <div class="text-right">
                                                <input id="id_vino" type="text" value="-1" name="id_vino" style="display: none;">
                                                <input type="text" value="vino-existe" name="accion" style="display: none;">
