<?php
    ...
    class vinoController{
        public function index(){
            ...
            require_once 'views/vinos/new_vinos.php';
        }
        ...
        public function save(){
            ...
            if(isset($_POST)){
                ...
                if($nombre && $region && $pais && $uva && $productor && $url_img){
                    $vino = new vinos();
                    $id = $vino->saveNewVino($nombre, $region, $pais, $uva, $productor, $url_img);
                    if($id != false){
                        echo "<script>";
                        echo "alert('Vino guardado correctamente');";
                        echo "window.location.replace('".base_url."vino/index');";
                        echo "</script>";
                    }
                    else{
                        echo "<script>";
                ...
                echo "<script>";
                echo "alert('Error, no se envio ningun dato');";
                echo "</script>";
            }
        }
        ...
        public function edit(){
            if(isset($_GET['id'])){
                $vino = new vinos();
                $vinos = $vino->getNewVinoId($_GET['id']);
                require_once 'views/vinos/updateVino.php';
            }
        }
